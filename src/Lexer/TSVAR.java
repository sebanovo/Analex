...
/** Esta class Implementa la tabla que almacena las variables (ID's) con su valor.
 *Por ejemplo:
 * 
 *       NOMBRE   VALOR 
 *   0 |"X1"    | 15    |
...
public class TSVAR {
    ...
    /* -Si nombre ya existe en la tabla, devolver (return) su posición (indice).
       -Si nombre no existe, insertar este en la tabla y devolver la posición donde fue insertado. 
    */
        return 0;
    }
